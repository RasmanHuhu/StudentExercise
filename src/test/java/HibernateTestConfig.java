...
public class HibernateTestConfig {
    ...
    private static EntityManagerFactory buildEntityFactoryConfig() {
        try {
            ...
            props.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/teststudents?currentSchema=public");
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        // add annotated classes - fortæl Hibernate hvilke Entity klasser vi har (Person)
